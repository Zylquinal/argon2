...
public class argon2_h {
    ...
    /**
     * {@snippet :
     * char* argon2_type2string(enum Argon2_type type, int uppercase);
     *}
     */
    ...
    /**
     * {@snippet :
     * int argon2_ctx(struct Argon2_Context* context, enum Argon2_type type);
     *}
     */
    ...
    /**
     * {@snippet :
     * int argon2i_hash_encoded(unsigned int t_cost, unsigned int m_cost, unsigned int parallelism, void* pwd, unsigned long pwdlen, void* salt, unsigned long saltlen, unsigned long hashlen, char* encoded, unsigned long encodedlen);
     *}
     */
    ...
    /**
     * {@snippet :
     * int argon2i_hash_raw(unsigned int t_cost, unsigned int m_cost, unsigned int parallelism, void* pwd, unsigned long pwdlen, void* salt, unsigned long saltlen, void* hash, unsigned long hashlen);
     *}
     */
    ...
    /**
     * {@snippet :
     * int argon2d_hash_encoded(unsigned int t_cost, unsigned int m_cost, unsigned int parallelism, void* pwd, unsigned long pwdlen, void* salt, unsigned long saltlen, unsigned long hashlen, char* encoded, unsigned long encodedlen);
     *}
     */
    ...
    /**
     * {@snippet :
     * int argon2d_hash_raw(unsigned int t_cost, unsigned int m_cost, unsigned int parallelism, void* pwd, unsigned long pwdlen, void* salt, unsigned long saltlen, void* hash, unsigned long hashlen);
     *}
     */
    ...
    /**
     * {@snippet :
     * int argon2id_hash_encoded(unsigned int t_cost, unsigned int m_cost, unsigned int parallelism, void* pwd, unsigned long pwdlen, void* salt, unsigned long saltlen, unsigned long hashlen, char* encoded, unsigned long encodedlen);
     *}
     */
    ...
    /**
     * {@snippet :
     * int argon2id_hash_raw(unsigned int t_cost, unsigned int m_cost, unsigned int parallelism, void* pwd, unsigned long pwdlen, void* salt, unsigned long saltlen, void* hash, unsigned long hashlen);
     *}
     */
    ...
    /**
     * {@snippet :
     * int argon2_hash(unsigned int t_cost, unsigned int m_cost, unsigned int parallelism, void* pwd, unsigned long pwdlen, void* salt, unsigned long saltlen, void* hash, unsigned long hashlen, char* encoded, unsigned long encodedlen, enum Argon2_type type, unsigned int version);
     *}
     */
    ...
    /**
     * {@snippet :
     * int argon2i_verify(char* encoded, void* pwd, unsigned long pwdlen);
     *}
     */
    ...
    /**
     * {@snippet :
     * int argon2d_verify(char* encoded, void* pwd, unsigned long pwdlen);
     *}
     */
    ...
    /**
     * {@snippet :
     * int argon2id_verify(char* encoded, void* pwd, unsigned long pwdlen);
     *}
     */
    ...
    /**
     * {@snippet :
     * int argon2_verify(char* encoded, void* pwd, unsigned long pwdlen, enum Argon2_type type);
     *}
     */
    ...
    /**
     * {@snippet :
     * int argon2d_ctx(struct Argon2_Context* context);
     *}
     */
    ...
    /**
     * {@snippet :
     * int argon2i_ctx(struct Argon2_Context* context);
     *}
     */
    ...
    /**
     * {@snippet :
     * int argon2id_ctx(struct Argon2_Context* context);
     *}
     */
    ...
    /**
     * {@snippet :
     * int argon2d_verify_ctx(struct Argon2_Context* context, char* hash);
     *}
     */
    ...
    /**
     * {@snippet :
     * int argon2i_verify_ctx(struct Argon2_Context* context, char* hash);
     *}
     */
    ...
    /**
     * {@snippet :
     * int argon2id_verify_ctx(struct Argon2_Context* context, char* hash);
     *}
     */
    ...
    /**
     * {@snippet :
     * int argon2_verify_ctx(struct Argon2_Context* context, char* hash, enum Argon2_type type);
     *}
     */
    ...
    /**
     * {@snippet :
     * unsigned long argon2_encodedlen(unsigned int t_cost, unsigned int m_cost, unsigned int parallelism, unsigned int saltlen, unsigned int hashlen, enum Argon2_type type);
     *}
     */
